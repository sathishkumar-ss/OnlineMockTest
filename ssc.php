...
<body>
  ...
  <div class="dropdown-container">
     <ul>
          <li><a href="quefolder/ssc2english.php">vocabulary</a></li>
          <li><a href="quefolder/ssc2onewordsubstitution.php">One Word Substitution </a></li>
  ...
  <button class="dropdown-btn">Verbal Reasoning<i class="fa fa-caret-down"></i></button>
    <div class="dropdown-container">
         <ul>
          <li><a href="quefolder/ssc2statementandconclusion.php">Statement and Conclusions</a></li>
...
<a href="question/ssc.php"><img src="images\question_bank.png" width="150x" height="150px"></a>
  <h4>QUESTION BANK</h4>
  </div>
  
    <div class="img">
  <a href="./video/video5.php"><img src="images\videos.png" width="150px" height="150px"></a>
  <h4>VIDEOS</h4></div>
    
    <div class="img">
    <a href="faq/faq_ssc.html"><img src="images\f&q.png" width="150px" height="150px"></a>
    <h4>FAQ</h4>
    </div>
...
<table>
  ...
  <div class="hero-image">
    <div class="hero-text">
    <h1 style="font-size:30px">Course | SSC </h1>
