...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `comvr` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `comvr` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>14){ 
  $qry3 = "SELECT `ans`, `userans` FROM `comvr`;";
