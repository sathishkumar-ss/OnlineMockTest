...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `upscpower` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `upscpower` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>11){ 
  $qry3 = "SELECT `ans`, `userans` FROM `upscpower`;";
...
<h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM upscpower";
