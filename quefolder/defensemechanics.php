...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `defensemechanics` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `defensemechanics` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>3){ 
  $qry3 = "SELECT `ans`, `userans` FROM `defensemechanics`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM defensemechanics";
