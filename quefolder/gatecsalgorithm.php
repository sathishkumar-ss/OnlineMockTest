...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `gatecsalgorithm` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `gatecsalgorithm` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>15){ 
  $qry3 = "SELECT `ans`, `userans` FROM `gatecsalgorithm`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM gatecsalgorithm";
