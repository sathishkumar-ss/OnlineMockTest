...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `gatecestrength` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `gatecestrength` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>13){ 
  $qry3 = "SELECT `ans`, `userans` FROM `gatecestrength`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM gatecestrength";
