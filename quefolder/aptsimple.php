...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `aptsimple` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `aptsimple` where id='$c'"; 
...
<div class="option">
<tr><td><h1><br><?php echo @$row['que'];?></h1></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 21){ ?>
 ...
 <?php if($_SESSION['clicks']>20){ 
  $qry3 = "SELECT `ans`, `userans` FROM `aptsimple`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM aptsimple";
