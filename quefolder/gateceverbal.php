...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `gateceverbal` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `gateceverbal` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>10){ 
  $qry3 = "SELECT `ans`, `userans` FROM `gateceverbal`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM gateceverbal";
