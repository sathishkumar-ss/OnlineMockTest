...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `gatecetransport` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `gatecetransport` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>6){ 
  $qry3 = "SELECT `ans`, `userans` FROM `gatecetransport`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM gatecetransport";
