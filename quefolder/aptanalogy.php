...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `aptanalog` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `aptanalog` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>14){ 
  $qry3 = "SELECT `ans`, `userans` FROM `aptanalog`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM aptanalog";
