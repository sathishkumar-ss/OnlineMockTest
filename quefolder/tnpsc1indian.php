...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `tnpsc1indian` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `tnpsc1indian` where id='$c'"; 
...
<div class="option">
<tr><td><h1><br><?php echo @$row['que'];?></h1></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 22){ ?>
 ...
 <?php if($_SESSION['clicks']>21){ 
  $qry3 = "SELECT `ans`, `userans` FROM `tnpsc1indian`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM tnpsc1indian";
