...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `aptinterst` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `aptinterst` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>18){ 
  $qry3 = "SELECT `ans`, `userans` FROM `aptinterst`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM aptinterst";
