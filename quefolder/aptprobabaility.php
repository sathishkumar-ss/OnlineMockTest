...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `aptprobability` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `aptprobability` where id='$c'"; 
...
<div class="option">
<tr><td><h1><br><?php echo @$row['que'];?></h1></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 20){ ?>
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>19){ 
  $qry3 = "SELECT `ans`, `userans` FROM `aptprobability`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM aptprobability";
