...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `gatecenumerical` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `gatecenumerical` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>10){ 
  $qry3 = "SELECT `ans`, `userans` FROM `gatecenumerical`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM gatecenumerical";
