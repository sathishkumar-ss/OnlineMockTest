...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `defencefilin` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `defencefilin` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>10){ 
  $qry3 = "SELECT `ans`, `userans` FROM `defencefilin`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM defencefilin";
