...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `netteaching` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `netteaching` where id='$c'"; 
...
<div class="option">
<tr><td><h1><br><?php echo @$row['que'];?></h1></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 11){ ?>
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>10){ 
  $qry3 = "SELECT `ans`, `userans` FROM netteaching;";
 ...
 ?>
 <h1 style="text-align: center;">The Answers Are</h1>
 <?php
$sql = "SELECT id,ans FROM netteaching";
