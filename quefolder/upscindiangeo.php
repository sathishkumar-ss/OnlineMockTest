...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `upscindiangeo` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `upscindiangeo` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>9){ 
  $qry3 = "SELECT `ans`, `userans` FROM `upscindiangeo`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM upscindiangeo";
