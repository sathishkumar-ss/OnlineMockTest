...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `defenseanalytic` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `defenseanalytic` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>10){ 
  $qry3 = "SELECT `ans`, `userans` FROM `defenseanalytic`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM defenseanalytic";
