...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `defensealgebra` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `defensealgebra` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>10){ 
  $qry3 = "SELECT `ans`, `userans` FROM `defensealgebra`;";
...
<h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM defensealgebra";
