...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `railclassification` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `railclassification` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>17){ 
  $qry3 = "SELECT `ans`, `userans` FROM `railclassification`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM railclassification";
