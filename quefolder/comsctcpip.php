...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `comsctcpip` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `comsctcpip` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>13){ 
  $qry3 = "SELECT `ans`, `userans` FROM `comsctcpip`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM comsctcpip";
