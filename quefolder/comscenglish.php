...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `comscenglish` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `comscenglish` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>18){ 
  $qry3 = "SELECT `ans`, `userans` FROM `comscenglish`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM comscenglish";
