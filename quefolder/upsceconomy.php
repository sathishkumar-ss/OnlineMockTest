...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `upsceconomy` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `upsceconomy` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>21){ 
  $qry3 = "SELECT `ans`, `userans` FROM `upsceconomy`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM upsceconomy";
