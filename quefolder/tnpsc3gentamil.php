...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `tnpsc3gentamil` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `tnpsc3gentamil` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>10){ 
  $qry3 = "SELECT `ans`, `userans` FROM `tnpsc3gentamil`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM tnpsc3gentamil";
