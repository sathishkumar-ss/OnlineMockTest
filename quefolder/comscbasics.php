...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `comscbasics` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `comscbasics` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>14){ 
  $qry3 = "SELECT `ans`, `userans` FROM `comscbasics`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM comscbasics";
