...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `tnpsc4generalphysics` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `tnpsc4generalphysics` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>10){ 
  $qry3 = "SELECT `ans`, `userans` FROM `tnpsc4generalphysics`;";
...
<h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM tnpsc4generalphysics";
