...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `aptvocabulary` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `aptvocabulary` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>11){ 
  $qry3 = "SELECT `ans`, `userans` FROM `aptvocabulary`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM aptvocabulary";
