...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `defenseelectronics` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `defenseelectronics` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>10){ 
  $qry3 = "SELECT `ans`, `userans` FROM `defenseelectronics`;";
 ...
 ?>
  ...
  <?php
$sql = "SELECT id,ans FROM defenseelectronics";
