...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `bankhardware` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `bankhardware` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>12){ 
  $qry3 = "SELECT `ans`, `userans` FROM `bankhardware`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM bankhardware";
