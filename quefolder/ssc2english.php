...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `ssc2english` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `ssc2english` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>13){ 
  $qry3 = "SELECT `ans`, `userans` FROM `ssc2english`;";
...
<h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM ssc2english";
