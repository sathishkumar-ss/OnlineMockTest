...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `railcoding` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `railcoding` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>15){ 
  $qry3 = "SELECT `ans`, `userans` FROM `railcoding`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM railcoding";
