...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `railgk` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `railgk` where id='$c'"; 
...
<tr><td><h1><br><?php echo @$row['que'];?></h1></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 21){ ?>
 ...
 <?php if($_SESSION['clicks']>20){ 
  $qry3 = "SELECT `ans`, `userans` FROM `railgk`;";
