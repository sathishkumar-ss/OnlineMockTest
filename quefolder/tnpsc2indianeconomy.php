...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `tnpsc2indianeconomy` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `tnpsc2indianeconomy` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>10){ 
  $qry3 = "SELECT `ans`, `userans` FROM `tnpsc2indianeconomy`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM tnpsc2indianeconomy";
