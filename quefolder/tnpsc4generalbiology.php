...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `tnpsc4generalbiology` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `tnpsc4generalbiology` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>14){ 
  $qry3 = "SELECT `ans`, `userans` FROM `tnpsc4generalbiology`;";
...
<h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM tnpsc4generalbiology";
