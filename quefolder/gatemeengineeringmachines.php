...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `gatemeengineeringmachines` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `gatemeengineeringmachines` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>7){ 
  $qry3 = "SELECT `ans`, `userans` FROM `gatemeengineeringmachines`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM gatemeengineeringmachines";
