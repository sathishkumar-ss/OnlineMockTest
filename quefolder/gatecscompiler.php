...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `gatecscompiler` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `gatecscompiler` where id='$c'"; 
...
<tr><td><h1><br><?php echo @$row['que'];?></h1></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 8){ ?>
 ...
 <?php if($_SESSION['clicks']>7){ 
  $qry3 = "SELECT `ans`, `userans` FROM `gatecscompiler`;";
