...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `railvocabulary` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `railvocabulary` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>5){ 
  $qry3 = "SELECT `ans`, `userans` FROM `railvocabulary`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM railvocabulary";
