...
<?php                               
                                ...
                                $fetchqry2 = "UPDATE `sscjeeanalog` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table>
  <?php if(isset($c)) {   $fetchqry = "SELECT * FROM `sscjeeanalog` where id='$c'"; 
...
<?php }  
 ...
 <?php if($_SESSION['clicks']>16){ 
  $qry3 = "SELECT `ans`, `userans` FROM `sscjeeanalog`;";
 ...
 <h3>The Answers are</h3>
  <?php
$sql = "SELECT id,ans FROM sscjeeanalog";
