...
<body>
  ...
  <div class="dropdown-container">
       <ul>
          ...
          <li><a href="quefolder/aptanalogy.php">Analogy</a></li>
          <li><a href="quefolder/aptbloodrelation.php">Blood Relation</a></li>
  ...
  <button class="dropdown-btn">Quantitive Aptitude<i class="fa fa-caret-down"></i></button>
  <div class="dropdown-container">
       <ul>
        <li><a href="quefolder/aptsimple.php">Simplification</a></li>
          
          <li><a href="quefolder/aptinterest.php">Interest</a></li>
          <li><a href="quefolder/aptprobabaility.php">Probability</a></li>
  ...
  <div class="dropdown-container">
       <ul>
          ...
          <li><a href="quefolder/aptvocabulary.php">Vocabulary</a></li>
...
<a href="question/aptitude.php"><img src="images\question_bank.png" width="150x" height="150px"></a>
  <h4>QUESTION BANK</h4>
  </div>
  
    <div class="img">
  <a href="./video/video7.php"><img src="images\videos.png" width="150px" height="150px"></a>
  <h4>VIDEOS</h4></div>
    
    <div class="img">
    <a href="faq/faq_aptitude.html"><img src="images\f&q.png" width="150px" height="150px"></a>
    <h4>FAQ</h4>
    </div>
...
<table>
  ...
  <div class="hero-image">
    <div class="hero-text">
    <h1 style="font-size:30px">Course | Aptitude </h1>
